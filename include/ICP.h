...
/* void InitScanMatching(float Bw, float Br,
                         int laserStep,float MaxDistInter, float filtrado,
...
int ICPmatcher(Tpf *laserRef, int numPointsRef, Tpf *laserNew, int numPointsNew,Tsc *sensorMotion, Tsc *solution);
